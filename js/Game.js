class Game {
          ...
          play(){
            form.hide();
            image(psee,0,0,displayWidth,displayHeight);
            
            image(psee,0,0,displayWidth,displayHeight);
            
            image(one1,0,0,displayWidth,displayHeight);

            image(two2,0,0,displayWidth,displayHeight);

            image(three3,0,0,displayWidth,displayHeight);

            image(go,0,0,displayWidth,displayHeight);
